...
function error403()
{
    core()->getResponse(array('status' => 403));
}
...
function error404()
{
    core()->getResponse(array('status' => 404));
}
...
/**
 * Format json into human-readable format.
 * 
...
/**
 * Get array of HTTP status codes. Keys are numeric statuses, values are human-readable strings.
 * 
 * @return array HTTP status codes.
 */
function getHttpStatusCodes()
{
    return array(
        100 => 'Continue',
